<?
    ...
    $material = "ЦПЧ";
        ...
        $arMaterial[$material]["text"] = "Цементно-песчаная черепица";
        $arMaterial[$material]["default"] = false;
    
        $parent = "Монтаж кровельного покрытия";
            $group = "Цементно-песчаная черепица и комплектующие";
            $arMainMaterial[$material][$parent][$group][$min] = '890 руб./кв.м';
            $arMainMaterial[$material][$parent][$group][$mid] = '990 руб./кв.м';
            $arMainMaterial[$material][$parent][$group][$max] = '1090 руб./кв.м';
        //*-
        ...
        $parent = "Работы по устройству кровли";    
            ...
            $arGroup[$material][$parent][$group]["expand"] = true;
                ...
                $arSmeta[$material][$parent][$group][$work][$min] = '185 руб./кв.м';
                $arSmeta[$material][$parent][$group][$work][$mid] = '215 руб./кв.м';
                $arSmeta[$material][$parent][$group][$work][$max] = '255 руб./кв.м';
            //*группа
