<?
    ...
    $material = "КомпЧ";
        ...
        $arMaterial[$material]["text"] = "Композитная черепица";
        $arMaterial[$material]["default"] = false;

        $parent = "Монтаж кровельного покрытия";
            $group = "Композитная черепица и комплектующие";
            $arMainMaterial[$material][$parent][$group][$min] = '990 руб./кв.м';
            $arMainMaterial[$material][$parent][$group][$mid] = '1090 руб./кв.м';
            $arMainMaterial[$material][$parent][$group][$max] = '1190 руб./кв.м';
        //*-
