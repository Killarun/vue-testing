<?
    ...
    $material = "ГЧ";
        ...
        $arMaterial[$material]["text"] = "Гибкая черепица";
        $arMaterial[$material]["default"] = false;

        $parent = "Монтаж кровельного покрытия";
                $group = "Гибкая черепица и комплектующие";
        ...
        $parent = "Работы по устройству кровли";    
            ...
            $arGroup[$material][$parent][$group]["expand"] = true;
				...
				$work = "Монтаж ОСП-плиты";
                $arSmeta[$material][$parent][$group][$work][$min] = '200 руб./кв.м';
                $arSmeta[$material][$parent][$group][$work][$mid] = '220 руб./кв.м';
                $arSmeta[$material][$parent][$group][$work][$max] = '240 руб./кв.м';
            //*группа
